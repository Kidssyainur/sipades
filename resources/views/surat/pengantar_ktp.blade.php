@extends('surat.partials.layout', ['judul' => 'Surat Pengantar Pembuatan KTP'])
...
@section('isi')
    ...
    <p style="margin-top:12px;">Untuk mengurus <strong>Kartu Tanda Penduduk (KTP)</strong> pada Dinas Kependudukan
