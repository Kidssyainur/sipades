...
use App\Filament\Resources\PersetujuanKepalaResource\Pages\ListPersetujuanKepala;
...
class PersetujuanKepalaResource extends Resource
{
    protected static ?string $model = PengajuanSurat::class;

    protected static string|BackedEnum|null $navigationIcon = 'heroicon-o-pencil-square';

    protected static ?string $navigationLabel = 'Persetujuan Kades';

    protected static ?string $modelLabel = 'Persetujuan Kades';

    protected static ?string $pluralModelLabel = 'Persetujuan Kades';
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->where('status', StatusPengajuan::DISETUJUI_SEKRETARIS->value);
    }
    ...
    {
        return [
            'index' => ListPersetujuanKepala::route('/'),
    ...
    public static function canViewAny(): bool
    {
        ...
        return $user->hasRole('admin') || $user->can('approve_level_3_sign') || $user->hasRole('kepala_desa');
    }
}
